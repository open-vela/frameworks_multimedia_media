...
static int media_focus_get_pollfds(struct MediadPlugin* ctx, struct pollfd* fds, void** cookies, int count)
{
...
static int media_focus_poll_available(struct MediadPlugin* ctx, struct pollfd* fd, void* cookies)
{
    media_focus* priv = ctx->priv;
